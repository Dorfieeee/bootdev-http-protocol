...
func TestRequestLineParse(t *testing.T) {
	...
	_, _, err = parseRequestLine([]byte("Do you have what it takes to be an engineer at TheStartup™?\r\n"))
	require.Error(t, err)
...
func TestReadingByChunks(t *testing.T) {
	// Test: Good GET Request line
	reader := &chunkReader{
		data:            "GET / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 256,
	...
	// Test: Non HTTP request
	reader = &chunkReader{
		data:            "Do you have what it takes to be an engineer at TheStartup™?\r\n",
		numBytesPerRead: 2,
	}
	r, err = RequestFromReader(reader)
	require.Error(t, err)
...
func TestParsingWithHeaders(t *testing.T) {
	...
	// Test: Standard Headers (read all at once)
	reader = &chunkReader{
		data:            "GET / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
	...
	// Test Fail: Missing End of Headers
	reader = &chunkReader{
		data:            "GET / HTTP/1.1\r\nHoSt: localhost:42069\r\n",
		numBytesPerRead: 256,
	}
